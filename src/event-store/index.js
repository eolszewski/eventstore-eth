...
module.exports = class EventStore {
   ...
   * @constructor
   * @memberof EventStore
   * @param {Object} config Config object requiring eventStoreArtifact, web3Config, and ipfsConfig
   */
  constructor(config) {
    if (!config) {
      throw new Error(
    ...
    let { eventStoreArtifact, web3Config, ipfsConfig } = config;
    ...
    this.ipfs = new IpfsAdapter(ipfsConfig);
  }
